...
export default function AcceleratedComputingTrainingPage() {
    ...
    const courseLinks: Record<string, string> = {
        ...
        'nvidiaBaseCommandManagerPrivateCustomTraining': '#',
    ...
    const initialNodes: Node[] = useMemo(() => {
        ...
        return [
            ...
            // Section 3: NVIDIA Base Command Manager
            {
            ...
            },
            {
                ...
                data: {
                    ...
                    price: '$ Custom',
                    type: 'purple',
                    link: courseLinks.nvidiaBaseCommandManagerPrivateCustomTraining,
                },
                style: { width: nodeWidth },
            },

            // Section 4: AI Infrastructure and Operations
            {
