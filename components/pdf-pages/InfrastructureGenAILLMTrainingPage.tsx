    ...
    const initialNodes: Node[] = useMemo(() => {
        ...
        return [
            // Section 1: Overview (Left Column) - Vertical flow
            {
                id: 'title-overview',
                type: 'title',
                position: { x: overviewX, y: rowStartY },
            ...
            },
            {
                ...
                type: 'course',
                position: { x: overviewX, y: rowStartY + titleHeight },
                data: {
            ...
            // Section 2: Introduction to Networking (Top Right)
            {
            ...
            // Section 3: Additional Recommended Training (Middle Right)
            {
            ...
            // Section 4: NVIDIA AI Enterprise (Bottom Left-Central, below Overview)
            {
            ...
            },
            {
                ...
                data: {
                    ...
                    price: '$30',
                    type: 'green',
                    link: courseLinks.rapidsAcceleratorApacheSpark,
                },
                style: { width: nodeWidth },
            },

            // Section 5: NVIDIA DGX (Bottom Left, below Overview, side by side with AI Enterprise)
            {
                id: 'title-nvidia-dgx',
                type: 'title',
