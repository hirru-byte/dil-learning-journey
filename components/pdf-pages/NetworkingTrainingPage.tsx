...
export default function NetworkingTrainingPage() {
    ...
    const courseLinks: Record<string, string> = {
        ...
        'nvidiaCumulusLinuxPrivateCustomizedWorkshop': '#',
        ...
        'aiNetworkingProfessionalCertification': '#',
    ...
    const initialNodes: Node[] = useMemo(() => {
        ...
        return [
            ...
            // Section 2: NVIDIA Cumulus (Mid-Left)
            {
            ...
            },
            {
                ...
                data: {
                    ...
                    price: '$ Custom',
                    type: 'purple',
                    link: courseLinks.nvidiaCumulusLinuxPrivateCustomizedWorkshop,
                },
                style: { width: nodeWidth },
            },

            // Section 3: AI Networking (Bottom Left) - Linear progression
            {
            ...
            },
            {
                ...
                data: {
                    ...
                    link: courseLinks.aiNetworkingProfessionalCertification,
                },
                style: { width: nodeWidth },
            },

            // Section 4: Other (Top Right)
            {
                id: 'title-other',
                type: 'title',
            ...
            },
            {
                ...
                data: {
                    ...
                    price: 'Free',
                    type: 'green',
                    link: courseLinks.rdmaOverConvergedEthernet,
                },
                style: { width: nodeWidth },
            },

            // Path 1: AI Infrastructure
            {
            ...
            // Combined Path: AI Infrastructure & Operations
            {
    ...
    const initialEdges: Edge[] = useMemo(() => [
        // AI Networking linear progression
        {
            id: 'e1',
        ...
        {
            id: 'e4',
            source: 'nvidiaCumulusLinuxPublicBootCamp-ai-networking',
        ...
        },
        {
            ...
            target: 'aiNetworkingProfessionalCertification',
            type: 'smoothstep',
            animated: false,
            markerEnd: { type: 'arrowclosed', color: '#9ca3af' },
            style: { stroke: '#9ca3af', strokeWidth: 2 },
        ...
        // Combined Path: AI Infrastructure & Operations to both certifications
        {
            id: 'e9',
